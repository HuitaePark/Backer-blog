...
public class PostService {
    ...
    public Long createPost(PostSaveRequestDto requestDto, Long userId) {
    ...
    public Page<PostListResponseDto> getPostList(String keyword, String category, Integer page, Integer size,
                                                 String sort) {
